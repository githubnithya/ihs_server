 ...
 * 
 * GET http://localhost:8080/resource_header ADD header key: Authorization value: Bearer access_token_valid
 * @author ADMIN
 *
 */
@Path("/resource")
public class ResourceEndPoint {
    ...
    public Response get(@Context HttpServletRequest request) throws OAuthSystemException {
        ...
        try {
            ...
            if (!Strings.ACCESS_TOKEN_VALID.equals(accessToken)) {

                // Return the OAuth error message
                OAuthResponse oauthResponse = OAuthRSResponse
                    .errorResponse(HttpServletResponse.SC_UNAUTHORIZED)
                    .setRealm(Strings.RESOURCE_SERVER_NAME)
